...
- `screenshots/home-page-before-question.png` — веб-интерфейс, стартовый экран
- `screenshots/ask-unanswerable.png` — честный отказ отвечать, если вопроса нет в базе знаний
